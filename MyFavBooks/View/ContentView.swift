...
// Represents a single row of books
struct BookRow: View {
    ...
    var body: some View {
        NavigationLink(
            ...
            HStack {
                Book.Image(
                    image: libary.images[book], title: book.title, size: 80,
                    cornerRadius: 12)
...
private struct SectionView: View {
    ...
    var body: some View {
        if let books = libary.sortedBooks[section] {
            SwiftUI.Section {
                ...
                .onDelete {
                    indexSet in
                    libary.deleteBooks(atOffSets: indexSet, section: section)
                }
                .onMove {
